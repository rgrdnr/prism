...
function TileShell({ href, icon, title, children, accent }: {
  ...
  const inner = (
    <div className="h-full bg-card/85 backdrop-blur-xs rounded-xl border border-border p-3 flex flex-col gap-2 hover:border-primary/30 transition-colors overflow-hidden">
